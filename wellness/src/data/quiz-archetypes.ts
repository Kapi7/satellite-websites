...
export const archetypes: Archetype[] = [
  {
    ...
    description:
      "You've built a solid wellness foundation across movement, sleep, stress management, and nutrition. You move regularly, sleep well, handle stress with awareness, and nourish your body with real food. Your challenge now isn't building habits — it's deepening them and staying consistent when life gets busy.",
  ...
  },
  {
    ...
    quickStartPlan: [
      ...
      'Day 2: Make a bone broth — sip it as your afternoon snack',
    ...
    seoDescription: 'The Grounded Mover wellness archetype — strong movement and nutrition habits. Discover how to optimise recovery and stress for peak performance.',
  },
  {
  ...
  },
  {
    ...
    seoDescription: 'The Calm Explorer wellness archetype — great movement and stress management. Discover how improving nutrition and sleep can unlock your full potential.',
  },
  {
    ...
    seoDescription: "The Restless Achiever wellness archetype — strong body but low recovery. Learn how fixing sleep and stress can unlock the gains you're chasing.",
  },
  {
    slug: 'sleep-seeker',
    ...
    seoDescription: 'The Sleep Seeker wellness archetype — your biggest wellness opportunity is better sleep. Get a 7-day plan to transform your rest and energy levels.',
  },
  {
  ...
  },
  {
    ...
    description:
      "You're at the beginning of your wellness journey, and that's a powerful place to be. Most pillars — movement, sleep, stress, and nutrition — have significant room for improvement, but that means even small changes will create noticeable results. Don't try to overhaul everything at once. Pick one pillar, build one habit, and let momentum do the rest.",
    ...
    seoDescription: "The Fresh Starter wellness archetype — you're at the beginning of your journey with huge potential. Get a simple 7-day plan to start building real habits.",
  },
];
