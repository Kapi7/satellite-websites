...
O excesso de ácidos graxos ômega-6 (abundantes em [óleos de sementes](/why-we-quit-seed-oils/)) promove vias inflamatórias. Quando a permeabilidade intestinal já está comprometida, essa inflamação se amplifica por todo o corpo, incluindo a pele.
