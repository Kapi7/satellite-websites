...
**Come allenarlo.** Trazioni (pull-ups), rematori (rows), face pulls. Se non riesci ancora a fare una trazione, è un obiettivo degno di nota. Abbiamo una guida sull'[allenamento della forza senza palestra](/strength-training-without-a-gym/) che include una progressione per le trazioni.
...
- [Allenamento della Forza Senza Palestra](/strength-training-without-a-gym/)