...
Ya hablamos de la terapia de frío para la recuperación en nuestra [guía de herramientas de recuperación](/5-recovery-tools-speed-muscle-healing/). La inmersión en agua fría reduce de forma fiable el DOMS (dolor muscular de aparición tardía) y los marcadores inflamatorios después de hacer ejercicio.
