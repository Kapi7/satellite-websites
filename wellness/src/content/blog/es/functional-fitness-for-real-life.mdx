...
**Cómo entrenarlo.** Dominadas (pull-ups), remos (rows), face pulls. Si aún no puedes hacer una dominada, ese es un objetivo que vale la pena. Tenemos una guía sobre [entrenamiento de fuerza sin gym](/strength-training-without-a-gym/) que incluye una progresión para dominadas.
...
- [Entrenamiento de Fuerza Sin Gym](/strength-training-without-a-gym/)