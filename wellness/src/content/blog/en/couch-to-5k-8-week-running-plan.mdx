...
Running three times per week burns approximately 600 to 900 calories total, which helps create a calorie deficit but is unlikely to produce significant weight loss on its own. Combining the program with a [meal prep plan](/weekly-meal-prep-weight-loss/) and mindful eating produces much better results than running alone.
