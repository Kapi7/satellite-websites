...
For more on building a smart shoe collection, check out our [shoe rotation guide](/running-shoe-rotation-guide/). And if you're deciding between walking and running, see [walking vs running](/el/walking-vs-running/).