...
<title>${title} — Glow Coded</title>
<style>body{font-family:system-ui,sans-serif;display:flex;justify-content:center;align-items:center;min-height:100vh;margin:0;background:#fff5f5}
...
h1{color:#9f1239;font-size:1.5rem;margin-bottom:.5rem}p{color:#64748b;line-height:1.6}
a{color:#e11d48;text-decoration:none;font-weight:600}</style></head>
<body><div class="card"><h1>${title}</h1><p>${message}</p><p><a href="https://glow-coded.com">Back to Glow Coded</a></p></div></body></html>`;
