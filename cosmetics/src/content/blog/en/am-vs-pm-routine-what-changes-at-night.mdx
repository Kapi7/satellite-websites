...
Apply generously: the "two-finger rule" (a line of sunscreen along your index and middle fingers) gives you approximately the right amount for your face and neck. If you haven't found a sunscreen that feels good enough to use daily, the [Beauty of Joseon Relief Sun](https://mirai-skin.com/products/beauty-joseon-relief-sun-ricex1) is the one that convinced several members of our team to stop skipping this step.
...
This is the step your morning routine doesn't have. An oil-based cleanser dissolves the sunscreen, makeup, and environmental grime that accumulated during the day. Massage it into dry skin for 30-60 seconds, add water to emulsify, and rinse. The [Anua Heartleaf Pore Control Cleansing Oil](https://mirai-skin.com/products/anua-heartleaf-pore-control-cleansing-oil-200ml) is a reliable pick here — it emulsifies cleanly and the heartleaf extract adds a calming first step.
...
- **Snail mucin.** The ultimate any-time ingredient. The [COSRX Snail 96 Mucin Essence](https://mirai-skin.com/products/cosrx-advanced-snail-96-mucin-power-essence-100ml) slots into both AM and PM seamlessly.
...
For the complete Korean skincare framework this routine fits into, see our [Korean Skincare Routine: The Complete Guide](/korean-skincare-routine-complete-guide/). And if you're unsure whether to use a toner, an essence, or both at each step, [toner vs. essence: what's the difference](/toner-vs-essence/) settles the sequencing question that derails most new routines.
