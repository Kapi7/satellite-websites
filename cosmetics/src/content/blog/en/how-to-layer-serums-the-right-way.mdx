...
Two to three serums per routine is the practical maximum. Beyond that, you risk pilling, reduced absorption, and irritation from too many actives competing for the same receptors. If you want to use more, split them between your morning and evening routines.

### Should you apply serums on wet or dry skin?

It depends on the serum. Hyaluronic acid works best on slightly damp skin because it needs moisture to attract. Vitamin C and retinol work best on completely dry skin to avoid irritation and ensure proper pH activation. When in doubt, wait 30 seconds after your previous step.

### Can you mix niacinamide and vitamin C?

Yes. The old advice that niacinamide and vitamin C cancel each other out was based on a 1963 study using extreme conditions that don't occur on human skin. Modern formulations of both ingredients work fine together. Many Korean products even combine them in a single formula.

### What order should serums go in?

Thinnest to thickest consistency. Water-based serums first, then gel serums, then oil-based serums. If two serums have similar consistency, apply the one with active ingredients that need lower pH first (like vitamin C before niacinamide).

**Related reading:** [Skincare Ingredient Compatibility Guide](/skincare-ingredient-compatibility-guide/), and if you want to understand where ampoules fit within your serum layering order, our [best Korean ampoules 2026 guide](/best-korean-ampoules-2026/) explains the ampoule vs serum vs essence distinction and ranks 10 picks by concern.
