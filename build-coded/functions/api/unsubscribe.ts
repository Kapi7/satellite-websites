...
<title>${title} — Build Coded</title>
<style>body{font-family:system-ui,sans-serif;display:flex;justify-content:center;align-items:center;min-height:100vh;margin:0;background:#f0f4f8}
...
h1{color:#334e68;font-size:1.5rem;margin-bottom:.5rem}p{color:#64748b;line-height:1.6}
a{color:#f0b429;text-decoration:none;font-weight:600}</style></head>
<body><div class="card"><h1>${title}</h1><p>${message}</p><p><a href="https://build-coded.com">Back to Build Coded</a></p></div></body></html>`;
