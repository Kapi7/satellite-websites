...
|------|---------|---------------|
| **Raspberry Pi 4 (4Go ou 8Go)** | Le serveur lui-même | 55-75 € |
| **Carte MicroSD (32Go+)** | Disque de démarrage | 8-12 € |
| Alimentation USB-C (5V/3A) | Alimentation | 8-10 € |
| Câble Ethernet | Connexion réseau fiable | 5 € |
| **Disque dur externe USB** | Stockage pour fichiers et médias | 40-80 € |
