...
Für Akzentbeleuchtung, Unterschrankbeleuchtung und Ambiente sind LED-Streifen unschlagbar. Sieh dir unsere detaillierte Anleitung zum [Bau einer individuellen LED-Streifenbeleuchtung](/how-to-build-led-strip-lighting/) für Installationsanweisungen an.
...
**Home Assistant** ist eine kostenlose Open-Source-Plattform für die Hausautomatisierung, die lokal auf einem [Raspberry Pi](/raspberry-pi-home-server-guide/) oder dedizierter Hardware läuft. Es unterstützt über 2.000 Integrationen und verarbeitet alles lokal – keine Cloud-Abhängigkeit.
