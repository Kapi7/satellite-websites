...
|------|---------|---------------|
| **Raspberry Pi 4 (4GB o 8GB)** | El servidor en sí | $55-75 |
| **Tarjeta MicroSD (32GB+)** | Unidad de arranque | $8-12 |
| Fuente de alimentación USB-C (5V/3A) | Alimentación | $8-10 |
| Cable Ethernet | Conexión de red confiable | $5 |
| **Disco duro externo USB** | Almacenamiento para archivos y medios | $40-80 |

### Opcional, pero recomendado

- **Carcasa de aluminio con enfriamiento pasivo** — mantiene la Pi fresca sin ventilador (operación silenciosa)
