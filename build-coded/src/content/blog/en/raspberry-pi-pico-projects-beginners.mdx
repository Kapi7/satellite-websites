...
**Difficulty:** Easy
**Time:** 30 minutes
**Parts:** Pico, nothing else (the onboard sensor is good enough), or a **DS18B20 waterproof probe** if you want to log outdoor temperature.
...
**Difficulty:** Easy
**Time:** 20 minutes
**Parts:** Pico, **HC-SR501 PIR sensor**, passive buzzer, jumper wires
...
**Time:** 30 minutes
**Parts:** Pico, **HC-SR04 ultrasonic sensor**, a 10k and 20k resistor (the sensor is 5 V, Pico is 3.3 V)
...
**Difficulty:** Moderate
**Time:** 45 minutes
**Parts:** Pico, **KY-040 rotary encoder**, a few pull-up resistors (often included on the module)
...
**Difficulty:** Moderate
**Time:** 45 minutes
**Parts:** Pico, **0.96 inch 128x64 SSD1306 OLED (I2C)**, jumper wires
...
**Difficulty:** Easy
**Time:** 30 minutes
**Parts:** Pico, **SG90 micro servo**, push button, 220 ohm resistor, external 5 V supply recommended
...
**Difficulty:** Moderate
**Time:** 1 hour
**Parts:** Pico, **TM1637 4-digit 7-segment display**, optional RTC module
...
**Difficulty:** Moderate
**Time:** 1 to 2 hours
**Parts:** **Raspberry Pi Pico W**, BME280 sensor optional for local data
