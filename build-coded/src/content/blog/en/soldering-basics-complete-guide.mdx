...
|------|---------|---------------|------|
| Soldering iron (temperature controlled) | Melting solder | **Pinecil V2** | $25-30 |
| Solder (rosin core, 60/40 or 63/37, 0.8mm) | The joining material | **Kester 44** | $10-15 |
| Brass wire tip cleaner | Cleaning the iron tip | Any brand | $5-8 |
| Soldering mat (silicone) | Protect your work surface | **Heat-resistant mat** | $8-12 |
